        ...
        <div>
            ...
            <main className="flex flex-col gap-10 bg-gray-200 md:py-[31px] md:px-[131px] items-center relative">
                ...
                <section
                    ...
                    }  z-10 items-center bg-black opacity-90 text-white p-5 absolute bottom-0 -top-0 w-[100%] justify-center`}
                >
                    <div className="z-20 flex flex-col gap-5 bg-white p-5 rounded-lg text-black md:w-[40%] ">
                        ...
                        <p className="text-center">Pay Later</p>
                    </div>
                </section>
            </main>
            <Footer />
